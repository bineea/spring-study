package org.tryImpl.framework.support;
...
import org.tryImpl.framework.context.DefaultListableBeanFactory;
...
//                System.out.println("desc->"+method.desc+":"+m.desc);
    ...
    public static void main(String[] args) throws IOException {
        for (Method m : DefaultListableBeanFactory.class.getDeclaredMethods()) {
            List<String> list = getMethodParamNames(DefaultListableBeanFactory.class, m);
